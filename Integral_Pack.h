        ...
        namespace anu {
            namespace qm {
                namespace ro {
                    class Integral_Pack {
                        public:
                            static Integral_Pack* _make(int N, int L, double Type,double roThresh, double rad);
                            Integral_Pack(int N, int L,double Type,double roThresh, double rad);
                            ~Integral_Pack();
                        ...
                        private:
                            int N,L; double Type;
                            int Ncal,Nprime; double thresh,rad;
                            // BRA
